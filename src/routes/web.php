...
Route::middleware(['web', \App\Http\Middleware\LanguageMiddleware::class])->group(function () {
    ...
    Route::prefix('{locale}')->group(function () {
        ...
        Route::middleware('auth:user')->prefix(__('routes.tickets'))->group(function () {
            Route::get('/', [TicketController::class, 'showAll'])->name('user.tickets.index');
            Route::get('/' . __('routes.create'), [TicketController::class, 'showCreateForm'])->name('user.tickets.create');
            Route::post('/', [TicketController::class, 'create'])->name('user.tickets.store');
            Route::get('/{ticket}', [TicketController::class, 'show'])->name('user.tickets.show');
            Route::post('/{ticket}/' . __('routes.comment'), [CommentController::class, 'addComment'])->name('ticket.add.comment');
            Route::post('/{ticket}/' . __('routes.validate'), [TicketController::class, 'validateResolution'])->name('user.tickets.validate');
        ...
        Route::middleware('auth:admin')->prefix(__('routes.admins'))->group(function () {

            Route::get('/' . __('routes.tickets'), [AdminTicketController::class, 'manageTickets'])->name('admin.manage.tickets');
            Route::get('/' . __('routes.tickets') . '/{ticket}', [AdminTicketController::class, 'viewTicket'])->name('admin.view.ticket');
            Route::patch('/' . __('routes.tickets') . '/{ticket}/' . __('routes.update'), [AdminTicketController::class, 'updateTicketStatus'])->name('admin.update.ticket');

            Route::get('/' . __('routes.users'), [AdminUserController::class, 'showListUsers'])->name('admin.dashboard.list.users');
            Route::get('/' . __('routes.users') . '/crear', [AdminUserController::class, 'createUser'])->name('admin.users.create');
            Route::post('/' . __('routes.users'), [AdminUserController::class, 'storeUser'])->name('admin.users.store');
            Route::get('/' . __('routes.users') . '/{user}/editar', [AdminUserController::class, 'editUser'])->name('admin.users.edit');
            Route::put('/' . __('routes.users') . '/{user}', [AdminUserController::class, 'updateUser'])->name('admin.users.update');
        });
    });
});
